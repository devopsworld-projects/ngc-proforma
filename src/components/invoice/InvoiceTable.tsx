      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-gray-100 border-none">
            ...
            <TableHead className="w-20 py-2 text-gray-700 text-xs font-semibold uppercase">Image</TableHead>
            <TableHead className="min-w-[180px] py-2 text-gray-700 text-xs font-semibold uppercase">Product</TableHead>
            <TableHead className="text-center py-2 w-14 text-gray-700 text-xs font-semibold uppercase">Qty</TableHead>
            ...
            >
                ...
                {item.productImage ? (
                  <HoverCard openDelay={200} closeDelay={100}>
                    <HoverCardTrigger asChild>
                      <div className="relative w-12 h-12 mx-auto cursor-pointer group">
                        <img 
                  ...
                  <div className="w-12 h-12 mx-auto flex items-center justify-center bg-gray-100 rounded-md border border-gray-300">
              ...
              <TableCell className="py-2">
                <div className="space-y-0.5">
                  <p className="font-semibold text-black text-sm">{item.brand || "-"}</p>
              ...
              <TableCell className="text-center py-2 text-sm font-mono text-gray-700">
                {item.gstPercent}%
              </TableCell>
              <TableCell className="text-right py-2 font-medium text-sm font-mono text-gray-700">
